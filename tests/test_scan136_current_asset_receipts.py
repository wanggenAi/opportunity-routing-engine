...
class Scan136CurrentAssetReceiptsTests(unittest.TestCase):
    ...
    def test_machine_state_preserves_historical_scan136_without_commercial_promotion(self):
        state = json.loads(STATE.read_text(encoding="utf-8"))
        self.assertEqual(state["scan136"]["scan_id"], "ATTRACTION_SCAN_136")
    ...
    def test_explicit_historical_jev_input_resolves_scan136(self):
    ...
    def test_resolved_research_formations_preserve_object_schema(self):
        ...
        self.assertTrue(resolved["ATTRACTION_SCAN_136-F3"]["verdict"].startswith("DEMOTED_"))
        self.assertTrue(resolved["ATTRACTION_SCAN_136-F4"]["verdict"].startswith("DEMOTED_"))
