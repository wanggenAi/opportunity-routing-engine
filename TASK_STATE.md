...
`1db17bc70f016e8badcd17c80ba2398371bec50d`
— squash merge of PR #409, `Run auditable-ledger outcome Scan 111`.

PR #409 final head `fa1280d1eee85954ea55cccd4e80f10a40a3da9a`:
- repository CI `35747192688`: success;
- live TypeSafe/Jev `35747192590`: success;
- live-shadow job `106811907638`: success;
- advisory artifact `10703326260`;
...
Merged-main push validation also succeeded:
- repository CI `35747346871`: success;
- Jev advisory `35747346734`: success.

That exact-head directive was consumed to start Scan 112.
